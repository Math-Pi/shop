...
<div class="panel admin-panel">
    <form action="${contextPath}/news/findBySql" id="listform" method="post">
        <div class="padding border-bottom">
            <ul class="search" style="padding-left: 10px;">
                <li>
                    <a class="button border-main icon-plus-square-o" href="${contextPath}/news/add">添加公告</a>
                </li>
                <li>
    ...
    <c:forEach items="${pagers.datas}" var="data" varStatus="l">
        <tr>
            ...
            <td>
                <a class="button border-main" href="${contextPath}/news/update?id=${data.id}"><span class="icon-edit">修改</span> </a>
                <a class="button border-red" href="${contextPath}/news/delete?id=${data.id}"><span class="icon-trash-o">删除</span> </a>
            </td>
        ...
        <tr>
            <td colspan="8">
                <div class="pagelist">
                    <!--分页开始-->
                    <pg:pager url="${contextPath}/news/findBySql" maxIndexPages="5" items="${pagers.total}" maxPageItems="5" export="curPage=pageNumber">
                        <pg:last>
