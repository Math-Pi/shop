...
<div class=" hidden_yh" style="width:100%!important;display:block;background: #f0f0f0;padding-top:34px;padding-bottom: 34px;">
    <div class="width1200 hidden_yh center_yh">
        <div id="vipRight" style="width: 1200px">
            <div class="hidden_yh bj_fff" style="width: 1198px;border: 1px solid #ddd;">
                <div class="font24" style="text-align: center;height: 50px;line-height: 50px;">${obj.name}</div>
