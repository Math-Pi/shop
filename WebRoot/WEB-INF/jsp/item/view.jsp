...
<div class="width1200 center_yh hidden_yh font14" style="height: 40px;line-height: 40px;">
    <span>当前位置：</span><a href="${contextPath}/login/uIndex" class="c_66">首页</a>
...
<div class="width1198 center_yh" style="height: 420px;">
    ...
    <div class="left_yh" style="width: 486px;height: 420px;margin-left: 42px;">
        ...
        <div class="buyFor">
            <a href="${contextPath}/sc/toAdd?itemId=${obj.id}" class="mstBuy">收藏</a>
            <a href="javascript:void(0)" class="addCar">加入购物车</a>
        </div>
    </div>
</div>
<div style="margin-top: 100px;">
    <div class="right_yh" style="width: 1500px;">
        <div id="spXqpj">
        ...
        <div class="hidden_yh">
            ...
            <div id="spPj">
                <div class=" hidden_yh" style="width:100%;padding-bottom: 20px;border-bottom: 1px dashed #ddd; margin-bottom: 10px;">
                    <c:forEach items="${obj.pls}" var="data" varStatus="l">
                        <div style="width: 790px;float: right;overflow:hidden;margin-top: 20px;">
                            <img src="${contextPath}/resource/user/images/zhangsan.jpg" style="width: 40px;height: 40px;border-radius: 50%;float: left;border:1px solid #ddd;margin-top: 20px;margin-right: 30px;">
...
<script>
    ...
    $(".addCar").click(function () {
        ...
        $.ajax({
            type:"POST",
            url:"${contextPath}/car/toAdd?itemId="+id+"&num="+num,
