...
<div class="panel admin-panel">
    <form action="${contextPath}/message/findBySql" id="listform" method="post">
    ...
    <c:forEach items="${pagers.datas}" var="data" varStatus="l">
        <tr>
            ...
            <td>${data.content}</td>
            <td>
                <a class="button border-red" href="${contextPath}/message/delete?id=${data.id}"><span class="icon-trash-o">删除</span> </a>
            </td>
        ...
        <tr>
            <td colspan="8">
                <div class="pagelist">
                    <!--分页开始-->
                    <pg:pager url="${contextPath}/message/findBySql" maxIndexPages="5" items="${pagers.total}" maxPageItems="5" export="curPage=pageNumber">
                        <pg:last>
