...
<div class="hidden_yh" style="background: #f0f0f0;padding-top:34px;padding-bottom: 34px;">
    <div class="width1200 hidden_yh center_yh">
        <div style="height: 60px;line-height: 60px;background: #f5f8fa;width: 900px;border:1px solid #ddd;margin-left: 200px;text-align: left;text-indent: 40px;">
            提交留言
        </div>
        <div class="bj_fff hidden_yh" style="width: 800px;border: 1px solid #ddd; margin-top: 0px;margin-left:200px;padding: 50px;">
            ...
            <div style="height: 100px;line-height: 100px;margin-top: 25px;">
