...
<div class="panel admin-panel">
    <form action="${contextPath}/user/findBySql" id="listform" method="post">
    ...
    <c:forEach items="${pagers.datas}" var="data" varStatus="l">
        ...
        <tr>
            <td colspan="8">
                <div class="pagelist">
                    <!--分页开始-->
                    <pg:pager url="${contextPath}/user/findBySql" maxIndexPages="5" items="${pagers.total}" maxPageItems="5" export="curPage=pageNumber">
                        <pg:last>
