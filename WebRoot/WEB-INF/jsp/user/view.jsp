...
<div class=" hidden_yh" style="width:100%;background: #f0f0f0;padding-top: 34px;padding-bottom: 34px;">
    <div class="width1200 hidden_yh center_yh">
        <div id="vipNav">
            <a href="${contextPath}/user/view" class="on">个人信息</a>
            <a href="${contextPath}/itemOrder/myOrder">我的订单</a>
            <a href="${contextPath}/sc/findBySql">商品收藏</a>
            <a href="${contextPath}/login/pass">修改密码</a>
        </div>
        <div id="vipRight">
            <form action="${contextPath}/user/exUpdate" method="post" id="myf">
                <div class="hidden_yh bj_fff" style="width: 938px;border: 1px solid #ddd;">
                    <div class=" font24" style="width:100%;height: 60px;line-height: 60px;text-indent: 50px; background: #f5f8fa;border-bottom: 1px solid #ddd;">基本信息</div>
                    ...
                    <div class="" style="width:100%;height: 32px;line-height: 32px;margin-top: 30px;">
