...
<div class="panel admin-panel">
    <form action="${contextPath}/itemOrder/findBySql" id="listform" method="post">
    ...
    <c:forEach items="${pagers.datas}" var="data" varStatus="l">
        <tr>
            ...
            <td>
                <a class="button border-main" href="${contextPath}/orderDetail/ulist?orderId=${data.id}"><span class="icon-edit">查看购买商品</span> </a>
                <c:if test="${data.status == 0}">
                    <a class="button border-red" href="${contextPath}/itemOrder/fh?id=${data.id}"><span class="icon-trash-o">去发货</span> </a>
                </c:if>
            </td>
        ...
        <tr>
            <td colspan="8">
                <div class="pagelist">
                    <!--分页开始-->
                    <pg:pager url="${contextPath}/itemOrder/findBySql" maxIndexPages="5" items="${pagers.total}" maxPageItems="5" export="curPage=pageNumber">
                        <pg:last>
