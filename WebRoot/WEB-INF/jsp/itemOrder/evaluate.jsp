...
<!--导航条-->
<div class="" style="width:100%;height: 45px;background: #dd4545;margin-top: 40px;position: relative;z-index: 100;">
    <!--中间的部分-->
...
<div class=" hidden_yh" style="width:100%;background: #f0f0f0;padding-top: 34px;padding-bottom: 34px;">
    <div class="width1200 hidden_yh center_yh">
        ...
        <div id="vipRight">
            ...
            <form action="${contextPath}/comment/toAdd" method="post" id="myf">
                ...
                <div class="bj_fff hidden_yh" style="width: 838px;height:120px;border: 1px solid #ddd; margin-top:30px;padding: 50px;">
                    ...
                    <div class="" style="width:100%;height: 32px;line-height: 32px;margin-top:85px;">
