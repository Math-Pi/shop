...
<head>
    ...
    <body style="margin-left: -40px;overflow-x: hidden;">
...
<div class="width1200 hidden_yh center_yh font20">全部商品<font class="red">（${fn:length(cars)}）</font> </div>
<div class="width1198 hidden_yh center_yh" style="border: 1px solid #ddd;margin-top: 18px;min-height: 300px;">
    <div class=" hidden_yh font14" style="width:100%;height: 32px;line-height: 32px;
    background: #f0f0f0;text-indent: 21px;color: #000; font-weight: 600;border-bottom: 1px solid #ddd;">商品详情</div>
    <div class=" hidden_yh fon14" style="width:100%;height: 42px;line-height: 42px;border-bottom: 1px solid #ddd;">
        ...
        <div class="left_yh tcenter font14" style="width: 175px;">总计</div>
        <div class="left_yh tcenter font14" style="width: 175px;">操作</div>
    </div>
    <c:forEach items="${cars}" var="data" varStatus="l">
        <div class="speCific" data-id="${data.id}">
            <div class="checkbox">
                <b><img src="${contextPath}/resource/user/images/checkbox.png"></b>
            </div>
            <div class="xzSp">
            ...
            <div class="xzSz" style="margin-right: 13px">
                <div class="xzCzIn">
...
<div class="width1198 center_yh" style="height: 60px;background: #f0f0f0;border:1px solid #ddd;margin-top:40px;">
    <div class="center_yh hidden_yh" style="width: 1178px;height: 60px;margin-left: 20px;">
        <div class="ifAll"><b><img src="${contextPath}/resource/user/images/checkbox.png"></b><font>全选</font></div>
...
<script>
    ...
    $(".Dels").click(function () {
       ...
       $.ajax({
           type:"POST",
           url:"${contextPath}/car/delete?id="+id,
    ...
    function ifJs() {
        ...
        $.ajax({
            type:"POST",
            url:"${contextPath}/itemOrder/toAdd",
