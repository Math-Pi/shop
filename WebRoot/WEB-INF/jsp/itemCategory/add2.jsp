...
<div class="panel admin-panel">
    <div class="panel-head" id="add">
        <strong><span class="icon-pencil-square-o">新增二级类别</span> </strong>
    </div>
    <div class="body-content">
        <form action="${contextPath}/itemCategory/toAdd2" method="post" class="form-x">
            <input type="hidden" name="pid" value="${pid}" />
            <div class="form-group">
                <div class="label"><label>二级类目类别：</label></div>
                <div class="field">
