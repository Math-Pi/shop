...
<div class="panel admin-panel">
    <div class="panel-head" id="add">
        <strong><span class="icon-pencil-square-o">新增一级类别</span> </strong>
    </div>
    <div class="body-content">
        <form action="${contextPath}/itemCategory/toAdd" method="post" class="form-x">
            <div class="form-group">
                <div class="label"><label>一级类别名称：</label></div>
                <div class="field">
